...
export function SpecialText({ children, speed = 20, delay = 0, className = "", inView = false, once = true }) {
  ...
  return (
    <span ref={containerRef} className={className} style={{ fontFamily: "monospace", display: "inline-block" }}>
      {displayText}
    </span>
  );
}